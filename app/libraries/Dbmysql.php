...
public function __construct($dbhost='10.52.21.3',$dbuser='comicweb',$dbpw='allen123',$dbname='comic') {
   $this->connect($dbhost,$dbuser,$dbpw,$dbname);
}

function connect($dbhost='10.52.21.3', $dbuser='comicweb', $dbpw='allen123', $dbname = 'comic', $dbcharset = 'utf8', $pconnect = 1, $tablepre='', $time = 0) {
$this->dbhost = $dbhost;
$this->dbuser = $dbuser;
$this->dbpw = $dbpw;
$this->dbname = $dbname;
